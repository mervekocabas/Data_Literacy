...
\vspace{-50pt}
\end{wrapfigure}
To analyse our research question, we categorize each paper based on the affiliations of its authors, as illustrated in Figure \ref{fig:affiliation-combination}. Each paper is analyzed to assign a percentage representation for corporate and academic institutions. By examining the affiliations of all contributing authors, we determine the proportion attributed to corporate entities versus academic institutions.
