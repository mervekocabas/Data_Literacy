...
'Signal and Statistical Processing': ['Electric potential',  'Phase estimation',  'Power grids', 'Solution design', 'High frequency', 'Encapsulation', 
                                      'Current transformers', 'Polarization', 'Speckle',  'Phase change materials', 'Pins',
